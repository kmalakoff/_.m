...
//  if (window.JSON) {
    ...
    equal(SS.stringify(_.flatten(list, /* REQUIRED */ NO)), @"[1,2,3,4]", @"can flatten nested arrays");
    equal(SS.stringify(_.flatten(list, /* REQUIRED */ YES)), @"[1,2,3,[[[4]]]]", @"can shallowly flatten nested arrays");
