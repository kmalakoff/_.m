...
#import "_Wrapper+ChainingTests.h"
#import "Underscore.h"
#import "SubjectiveScript.h"

@implementation _Wrapper_ChainingTests
...
- (void)test_map_flatten_reduce
{
  ...
  O* counts = (O*) _.chain(lyrics).chain()
